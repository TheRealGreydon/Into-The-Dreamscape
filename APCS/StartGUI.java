...
public class StartGUI extends JFrame implements ActionListener
{
    ...
    public StartGUI() {sPanel = new JPanel();sPanel = b;sPanel.setLayout(new GridBagLayout());}
    ...
    private void name()
    {
        nameBox = new JTextField(9);gbc.fill = GridBagConstraints.HORIZONTAL;gbc.ipady = 0;gbc.weighty = 1.0;gbc.anchor = GridBagConstraints.CENTER;gbc.gridx = 3;       
        gbc.gridwidth = 1;gbc.gridy = 1;nameBox.setFont(new Font("SansSerif", Font.PLAIN, 48));sPanel.add(nameBox,gbc);

        JLabel title = new JLabel();gbc.fill = GridBagConstraints.NONE;
        gbc.gridy = 0;title.setBorder(BorderFactory.createLineBorder(Color.black, 5));title.setOpaque(true);title.setBackground(Color.WHITE);
        title.setFont(new Font(title.getFont().getName(), Font.BOLD, 40));title.setText("What is your name?");sPanel.add(title,gbc);

        buttons[0]=new JButton();gbc.gridx=12;gbc.gridy = 1;gbc.anchor = GridBagConstraints.LINE_END; 
        sPanel.add(buttons[0],gbc);buttons[0].setPreferredSize(new Dimension(100,100));buttons[0].setBackground(new Color(179, 9, 9));
    ...
    private void gend()
    {
        ...
        gbc.fill = GridBagConstraints.HORIZONTAL;gbc.ipady = 0;gbc.weighty = 0;gbc.anchor = GridBagConstraints.PAGE_START;gbc.gridx = 2;gbc.gridwidth = 1;gbc.gridy = -1;       
        title.setOpaque(true);title.setBackground(Color.WHITE);title.setFont(new Font(title.getFont().getName(), Font.BOLD, 40));
        title.setText("What gender are you?");title.setBorder(BorderFactory.createLineBorder(Color.black, 5));sPanel.add(title,gbc);

        gbc.gridx=10;gbc.weighty = 1;gbc.gridy = 1;       
        gbc.anchor = GridBagConstraints.LINE_END;sPanel.add(buttons[0],gbc);buttons[0].setPreferredSize(new Dimension(100,100));buttons[0].setBackground(new Color(179, 9, 9));
        buttons[0].setBorder(BorderFactory.createLineBorder(new Color(43,18,204), 5));buttons[0].setFont(new Font(buttons[0].getFont().getName(), Font.BOLD, 15));buttons[0].setText("NEXT");

        buttons[1]=new JButton();gbc.gridx=0;gbc.anchor = GridBagConstraints.LINE_START; 
        sPanel.add(buttons[1],gbc);buttons[1].setPreferredSize(new Dimension(100,100));buttons[1].setBackground(new Color(179, 9, 9));buttons[1].setBorder(BorderFactory.createLineBorder(new Color(43,18,204), 5));
        buttons[1].setFont(new Font(buttons[1].getFont().getName(), Font.BOLD, 15));buttons[1].setText("BACK");buttons[1].setForeground(Color.black);buttons[1].addActionListener(this);

        buttons[2]=new JButton();gbc.gridx = 1;gbc.anchor = GridBagConstraints.CENTER;sPanel.add(buttons[2],gbc);buttons[2].setPreferredSize(new Dimension(200,100));
        buttons[2].setBackground(new Color(179, 9, 9));buttons[2].setBorder(BorderFactory.createLineBorder(new Color(43,18,204), 5));
        buttons[2].setFont(new Font(buttons[2].getFont().getName(), Font.BOLD, 15));buttons[2].setForeground(Color.black);buttons[2].setText("Male");buttons[2].addActionListener(this);

        buttons[3]=new JButton();gbc.gridx = 2;sPanel.add(buttons[3],gbc);
        buttons[3].setPreferredSize(new Dimension(100,100));buttons[3].setBackground(new Color(179, 9, 9));buttons[3].setBorder(BorderFactory.createLineBorder(new Color(43,18,204), 5));
        buttons[3].setFont(new Font(buttons[3].getFont().getName(), Font.BOLD, 15));buttons[3].setForeground(Color.black);buttons[3].setText("Female");buttons[3].addActionListener(this);

        buttons[4]=new JButton();gbc.gridx = 3;sPanel.add(buttons[4],gbc);
        buttons[4].setPreferredSize(new Dimension(200,100));buttons[4].setBackground(new Color(179, 9, 9));buttons[4].setBorder(BorderFactory.createLineBorder(new Color(43,18,204), 5));
        buttons[4].setFont(new Font(buttons[4].getFont().getName(), Font.BOLD, 15));buttons[4].setForeground(Color.black);buttons[4].setText("Non-Binary");buttons[4].addActionListener(this);

        BufferedImage out1=null;BufferedImage out2=null;BufferedImage out3=null;Image out1S;Image out2S;Image out3S;

        try {out1 = ImageIO.read(new File("APCS/Assets/Character Img/Char1.jpg"));} catch (IOException e) {e.printStackTrace();}out1S = out1.getScaledInstance(650, 650, Image.SCALE_SMOOTH);
        JLabel out1lab = new JLabel(new ImageIcon(out1S));out1lab.setPreferredSize(new Dimension(300,450));gbc.fill = GridBagConstraints.NONE;
        gbc.ipady = 0;gbc.weighty = .5;gbc.gridx = 1;gbc.gridwidth = 1;gbc.gridheight=1;gbc.gridy = 0;sPanel.add(out1lab, gbc);

        try {out2 = ImageIO.read(new File("APCS/Assets/Character Img/Char2.jpg"));} catch (IOException e) {e.printStackTrace();}out2S = out2.getScaledInstance(650, 650, Image.SCALE_SMOOTH);
        JLabel out2lab = new JLabel(new ImageIcon(out2S));out2lab.setPreferredSize(new Dimension(300,450));gbc.gridx = 2;sPanel.add(out2lab, gbc);
